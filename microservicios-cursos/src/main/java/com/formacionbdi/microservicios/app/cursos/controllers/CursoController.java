...
public class CursoController extends CommonController<Curso, CursoService> {
	...
	public ResponseEntity<?> asignarAlmunos(@RequestBody List<Alumno> alumnos, @PathVariable Long id){
		Optional<Curso> o = service.findById(id);
	...
	public ResponseEntity<?> eliminarAlmuno(@RequestBody Alumno alumno, @PathVariable Long id){
		Optional<Curso> o = service.findById(id);
	...
	public ResponseEntity<?> buscarPorAlumnoId(@PathVariable Long id){
		Curso curso = service.findCursosByAlumnoId(id);
